...
//document.domain = "http://localhost:8081/member/signup";
...
function init(){
	...
	var confmKey = "devU01TX0FVVEgyMDIzMDQzMDExMDYyNDExMzczMzY=";
	...
	if(inputYn != "Y"){
		...
		document.form.action="http://business.juso.go.kr/addrlink/addrLinkUrl.do"; //인터넷망
